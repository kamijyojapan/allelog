...
* **「証拠」を自動保存:**
    * 症状を入力した際、**「過去1週間分の食事と服薬の記録」**を自動的にパッケージ化して保存します。後から食事ログを整理しても、診断に必要なデータは消えません。
...
* **機能:**
    ...
    * **詳細確認:** 記録をタップすると、発症直前の1週間に「何を食べていたか」「薬を飲んでいたか」を即座に確認できます。
...
## 🆕 最近の更新
- Service WorkerをNetwork First戦略に変更し、アプリ更新がすぐに反映されるように改善。
- Persistent Storage APIを実装し、ブラウザのデータ削除で記録が消えるリスクを軽減。
